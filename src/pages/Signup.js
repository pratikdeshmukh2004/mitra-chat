...
import { faAddressCard, faArrowRight, faArrowRightLong, faEnvelope, faEye, faPersonWalkingArrowRight, faUserPlus } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div className="min-h-screen bg-cover bg-center relative" style={{ backgroundImage: `url('/images/login_cover.jpg')` }}>
      <div className="absolute top-0 left-0 h-full w-full bg-gradient-to-bl lg:bg-gradient-to-l from-transparent via-gray-900 to-gray-900" style={{ backdropFilter: 'blur(5px)' }}>
        <div class="h-16 mt-20 lg:ml-20 ml-0">
          <a className='flex flex-row ml-8'>
            <span className='w-8 h-8 rounded-full animate-pulse bg-green-500'></span>
          ...
          <form autoComplete='off' aria-autocomplete='off' className='ml-10'>
            ...
            <div className='flex gap-0 lg:gap-5 flex-col lg:flex-row'>
              <div class="bg-gray-800 focus-within:ring-1 ring-green-400 rounded-xl px-6 pt-1 pb-2 mt-10 lg:w-44 w-72">
                ...
                <span class="flex">
                  <input autoFocus class="bg-gray-800 rounded-lg w-full outline-none font-bold text-sm text-white capitalize" type="text" />
            ...
            <div class="bg-gray-800 focus-within:ring-1   ring-green-400  rounded-xl px-6 pb-2 pt-1 mt-5 w-72 lg:w-96">
              ...
              <span class="flex">
                <input type="password" class="bg-gray-800 rounded-lg w-full outline-none font-bold text-sm text-white lowercase" />
                <FontAwesomeIcon className='ml-2 text-lg -mt-2 text-gray-400' icon={faEye} />
              </span>
            </div>
            <div className='mt-10 gap-4 '>
              ...
              <p className='text-sm text-gray-500 mt-2 ml-1'>Already have an account? <Link to={'/login'} className='text-green-500 hover:text-green-800'>Access your account</Link></p>
            </div>
          </form>
        </div>
      </div>
